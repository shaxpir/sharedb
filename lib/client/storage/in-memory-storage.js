 ...
 */
InMemoryStorage.prototype.initialize = function(callback) {
  var storage = this;
  var start = Date.now();
...
/**
 * Reads multiple records by ID from the specified store in a single operation.
 *
 ...
 */
InMemoryStorage.prototype.readRecordsBulk = function(storeName, ids, callback) {
  this.ensureReady();
