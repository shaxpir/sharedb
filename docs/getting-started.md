...
There are [working examples](https://github.com/sharesync-dev/sharedb/tree/master/examples) in the git repository.
...
Try running the [working example](https://github.com/sharesync-dev/sharedb/tree/master/examples/counter) to see this in action.
